...
The evidence cited above suggests that, at least for the case of deception, speaker modelling is fast, and not always accurate:
That is, listeners appear to heuristically associate disfluency with lying.
However, it is possible that any inaccuracy is the outcome of a more detailed attempt to model the speaker:
Lying is associated with cognitive effort, and cognitive effort is associated with disfluency, which leads to the conclusion that disfluency matches lying.
This may in part be predicated on introspection:
Speakers believe themselves to be more disfluent when lying \citep{Zuckerman1981}.
The proof of this conjecture would lie in whether context were properly taken into account.
If listeners are reasoning about the causes of speakers' disfluencies, and alternate causes of those disfluencies are readily available, then the association between disfluency and lying should be weakened.

%%%%%%%%%%%%%%%%%%%%%%%% HERE
%%%%% nb., getting disfluency wrong is evidence against a stochastic model
