...
However, a parallel literature shows that in some circumstances, disfluency may also have pragmatic effects, in that it has direct consequences for the way a listener interprets an utterance.
%
...
Listeners faced with disfluency had less confidence in the speaker's knowledge (a weaker ``Feeling of Another's Knowing'', or FOAK), and therefore revised their estimates concerning factual correctness of what was being said.
...
Instead, in the absence of a very clear indication to the contrary, they may heuristically associate certain aspects of spoken performance with uncertainty or lying, perhaps based on previous co-occurrence or based on a superficial model of the speaker.
...
If detailed speaker modelling is occurring, any inferences regarding the cause of a given disfluency would have to have been made very fast.

%%% so this becomes another reason for assuming that it's a heuristic????
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Another reason for assuming that a heuristic is at play is that any models which listeners might have of speakers in the context of lying may be inaccurate.
...
Moreover, \citet{DePaulo1982actual} demonstrated a  mismatch between disfluency as an actual and as a perceived cue to deception:
...
Lying is associated with cognitive effort, and cognitive effort is associated with disfluency, which leads to the conclusion that disfluency signals lying.
This conclusion may in part be predicated on introspection: Speakers believe themselves to be more disfluent when lying \citep{Zuckerman1981}.
Evidence for this conjecture would lie in whether context were properly taken into account.
...
The current study investigates the view in the literature on deception recognition that the disfluency-lying association results from an attempt to model the speaker.
To do this, we look at whether the association between disfluency and lying is modulated by contextual information.
...
Thus the study followed a 2 (fluent vs disfluent) x 2 (distraction absent vs present) design.
...
The car-horn provides a local cause of speaker disfluency.
The extent to which listeners' disfluency-lying biases are influenced by this local cause of disfluency will give an indication to the extent to which any speaker modelling might occur.
If listeners rely upon an heuristic association between disfluency and deception---be it a prelearned assocation or a result of superficially modelling dishonest speakers as being often disfluent---then the car-horn should not influence the judgments they make about a speaker's honesty. 
Alternatively, if listeners actively model a given speaker to account for a specific disfluency, the association between disfluency and deception should be weakened when the car-horn is present:
