...
\citeauthor{Loy2016}'s study was framed as a treasure hunting game.
In each trial, listeners were asked to indicate which of two depicted objects they believed was concealing some treasure, by clicking on that object.
...
We considered it to be more believable that an environmental distraction might cause a disfluency once a speaker had initiated an utterance.
...
To reinforce the cover story, the initial explanation of the experiment included three videos which purported to be examples of the speaker producing the utterances. 
These were presented alongside the images that the speaker spoke about. The speaker's fluency and honesty were varied in these videos, as was the presence of a distraction that might have caused any disfluency.
...
\footnote{Including participants who did not believe that the utterances were produced naturally and in a noisy environment did not change the pattern of results (disfluency-deception bias: $\beta = -0.51$; $\SE = 0.05$; $t=-10.84$; effect of speaker-distraction: $\beta = 0.26$; $\SE = 0.07$; $t=3.90$).}
