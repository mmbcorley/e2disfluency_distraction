...
%%%MC note linking phrases---always handy :)
Importantly, however, listeners were not neutral with regard to the available distractions.
...
At face value, the finding may be taken to suggest that listeners in the present study are modelling the speaker's production system in enough detail to be able to attribute a cause to a given disfluency.

There are, however, two potential alternative accounts of this finding.
The first is a heuristic
