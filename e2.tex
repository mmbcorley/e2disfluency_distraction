...
This draws on a broader question in language comprehension: to what extent does a listener model the thoughts, intentions and perspective of a speaker?
...
Despite this, the suggestion that language users engage in a form of perspective-taking \citep{Clark1981} has been influential. 
The idea that interlocutors produce and interpret language against their common ground---against a sort of meta-knowledge about what is mutually known to be shared by speaker and listener---offers a solution to how communication is possible despite so much ambiguity in language use, with speakers and listeners tailoring their utterances and speech processing to a specific conversational partner. 
More recently, however, research has suggested that language users instead appear to often rely on less cognitively demanding, `egocentric' tactics, only engaging in perspective-taking when entirely necessary \citep{Barr2002, Barr2004, Barr2014, Pickering2004, Kronmuller2007}. 
%In comprehension, evidence for this egocentricism has been found in the processing of definite referring expressions---\citet{Keysar2000} found that when presented with an utterance of ``pick up the small candle.'', listeners fail to account for the intended referent being smallest one the speaker knows about, instead often considering a candle which is not visible to the speaker. 
%However, research has shown that effects of common ground and perspective are present during early stages of processing despite the interference of a listeners' own, privileged knowledge \citep{Hanna2003}.\\
Paralinguistic cues such as disfluency offer a novel means of investigating the extent to which listeners engage in perspective-taking during comprehension, inasmuch as they 
...
why refer to privileged knowledge in processing disfluency?
...
When a speaker lies, however, their intention is to convey a statement which they do not regard as true. 
...
%why is moment-to-moment important? explai, and link to below - back to question
